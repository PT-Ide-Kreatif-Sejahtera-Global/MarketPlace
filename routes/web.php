...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/admin/product/add', [AdminControllers::class, 'addProduct'])->name('admin.product.add');
    Route::post('/admin/product/store', [AdminControllers::class, 'store'])->name('admin.product.store');
