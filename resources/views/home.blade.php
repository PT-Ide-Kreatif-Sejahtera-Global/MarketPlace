<x-home-layout>
    ...
    <div class="relative">
        <!-- Swiper Container -->
        <div class="swiper-container mx-auto px-4 py-8 overflow-hidden">
            <div class="flex justify-between items-center my-5">
                <h2 class="text-lg md:text-2xl font-bold text-secondary-dark">Produk Fashion Terbaru</h2>
                <a href="{{ route('product.paginate.produk') }}" class="text-sm md:text-base text-end font-medium text-primary-dark hover:font-semibold hover:underline">See all</a>
            </div>
            <div class="swiper-wrapper">
                @php
                    $categories = ['pakaian pria', 'pakaian wanita', 'tas pria', 'tas wanita', 'aksesoris'];
                    $filteredProducts = $product->whereIn('kategori', $categories)->take(10);
                @endphp
